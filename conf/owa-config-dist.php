...
define('OWA_DB_NAME', '__DB_NAME__'); // name of the database
define('OWA_DB_HOST', 'localhost'); // host name of the server housing the database
define('OWA_DB_USER', '__DB_USER__'); // database user
define('OWA_DB_PORT', '3306'); // port of database
define('OWA_DB_PASSWORD', '__DB_PWD__'); // database user's password
